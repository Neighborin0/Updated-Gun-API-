...
namespace FrostAndGunfireItems
{
    ...
    public class BasicGun : GunBehaviour
    {
        ...
        //.Json determines the hand sprites for your character. You can make a gun two handed by having both "SecondaryHand" and "PrimaryHand". 
        //By default this gun is a one-handed weapon
        //If you need a basic two handed .json. Just use the basicgun2.json.
        //And finally, don't forget to add your Gun to the ModTest.
